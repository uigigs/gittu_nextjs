...
const Header = () => {
    ...
    // Function to handle smooth scroll to the #demos section
            ...
            <ContainerWrapper>
                <div className="flex items justify-between py-[30px] md:py-[15px]">
                    ...
                    <div className="flex items justify-end gap-[30px] md:gap-[15px]">
                        <a
                            href="#demos"
                            onClick={scrollToDemos} // Attach the scroll handler here
                        ...
                        <Link
                            href="https://themeforest.net/user/uigigs/portfolio"
                            target='_blank'
